<template>
    <section>
        ...
        <div class="requests-wrapper mt-4">
            <div>
                <el-radio v-model="request" label="video" border
                    >Video</el-radio
                >
                <el-radio v-model="request" label="leave" border
                    >Leave</el-radio
                >
            </div>
                ...
                <template v-if="request === 'video'">
                    <div class="components">
                        ...
                        <div class="mt-2 textArea">
                            ...
                            <div class="mt-3 warning-msg" v-if="warn">
    ...
    methods: {
        selectDay(value) {
            ...
            if (!(this.day <= new Date())) {
                this.warn = true;
                this.message =
                    "Video lecture date is invalid. Video lecture date should be in past";
            } else {
                this.message = "";
                this.warn = false;
            }
