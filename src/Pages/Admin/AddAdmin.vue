  ...
  <section>
    ...
    <div class="mt-4">
      <el-tabs v-model="activeName">
        <el-tab-pane label="Add Admin" name="add-admin">
            ...
            <form @submit.prevent="addUser">
              <div class="my-1">
                ...
                <div v-if="$v.user.email.$error" class="text-danger">
                  ...
                  <div v-else-if="!$v.user.email.email" class="error-message">
              ...
              <div class="my-1">
                ...
                <div v-if="$v.user.phone.$error" class="text-danger">
                  <div v-if="!$v.user.phone.required" class="error-message">
                    <small>The phone field is required</small>
                  </div>
                  <div v-if="!$v.user.phone.numeric" class="error-message">
                  ...
                  <div
                    ...
                    class="error-message"
                  >
                    <small>The phone number should be of 10 digits</small>
                  </div>
                </div>
              </div>
              <div class="my-1">
        ...
        <el-tab-pane label="View Admins" name="view-admins">
          <AdminTable @getAllAdmin="getAllAdmins" :adminList="adminList" />
        </el-tab-pane>
      </el-tabs>
    </div>
  </section>
  ...
  methods: {
    ...
    async getAllAdmins() {
      try {
        ...
        this.$toast.error(
          "There was some error while fetching admin list",
          this.$config.toastConfig
        );
      }
    },
